...
public class ExtraCreativeTabs {
    public static final CreativeTabDeferredRegister EXTRA_CREATIVE_TABS = new CreativeTabDeferredRegister(
        MekanismExtras.MOD_ID,
        ExtraCreativeTabs::addToExistingTabs
    );

    public static final MekanismDeferredHolder<CreativeModeTab, CreativeModeTab> MEK_EXTRAS = EXTRA_CREATIVE_TABS.registerMain(
        ExtraLang.MEK_EXTRAS,
        ExtraItems.INFINITE_CONTROL_CIRCUIT,
